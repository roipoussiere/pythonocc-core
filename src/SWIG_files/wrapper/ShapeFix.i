...
%extend Handle_ShapeFix_EdgeProjAux {
    ...
    return (ShapeFix_EdgeProjAux*)$self->get();
    }
};
...
%extend Handle_ShapeFix_ComposeShell {
    ...
    return (ShapeFix_ComposeShell*)$self->get();
    }
};
...
%extend Handle_ShapeFix_FixSmallFace {
    ...
    return (ShapeFix_FixSmallFace*)$self->get();
    }
};
...
%extend Handle_ShapeFix_FixSmallSolid {
    ...
    return (ShapeFix_FixSmallSolid*)$self->get();
    }
};
...
%extend Handle_ShapeFix_Shape {
    ...
    return (ShapeFix_Shape*)$self->get();
    }
};
...
%extend Handle_ShapeFix_Shell {
    ...
    return (ShapeFix_Shell*)$self->get();
    }
};
...
%extend Handle_ShapeFix_Solid {
    ...
    return (ShapeFix_Solid*)$self->get();
    }
};
...
%extend Handle_ShapeFix_SplitCommonVertex {
    ...
    return (ShapeFix_SplitCommonVertex*)$self->get();
    }
};
...
%extend Handle_ShapeFix_Wireframe {
    ...
    return (ShapeFix_Wireframe*)$self->get();
    }
};
