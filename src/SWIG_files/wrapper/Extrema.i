...
%extend Handle_Extrema_ExtPExtS {
    ...
    return (Extrema_ExtPExtS*)$self->get();
    }
};
...
%extend Handle_Extrema_ExtPRevS {
    ...
    return (Extrema_ExtPRevS*)$self->get();
    }
};
...
class Extrema_GenLocateExtPS {
	...
	:param theS:
	:type theS: Adaptor3d_Surface &
	:param theTolU: default value is Precision::PConfusion()
	:type theTolU: float
	:param theTolV: default value is Precision::PConfusion()
	:type theTolV: float
	:rtype: None
