...
%enddef
%template(IGESData_Array1OfIGESEntity) NCollection_Array1 <Handle(IGESData_IGESEntity)>;
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_FileRecognizer(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_FileRecognizer::Handle_IGESData_FileRecognizer %{
...
class Handle_IGESData_FileRecognizer : public Handle_Standard_Transient {
    ...
    public:
        ...
        static const Handle_IGESData_FileRecognizer DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_FileRecognizer {
    IGESData_FileRecognizer* _get_reference() {
    return (IGESData_FileRecognizer*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_GeneralModule(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_GeneralModule::Handle_IGESData_GeneralModule %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_GeneralModule : public Handle_Interface_GeneralModule {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_GeneralModule DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_GeneralModule {
    IGESData_GeneralModule* _get_reference() {
    return (IGESData_GeneralModule*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_GlobalNodeOfSpecificLib(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_GlobalNodeOfSpecificLib::Handle_IGESData_GlobalNodeOfSpecificLib %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_GlobalNodeOfSpecificLib : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_GlobalNodeOfSpecificLib DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_GlobalNodeOfSpecificLib {
    IGESData_GlobalNodeOfSpecificLib* _get_reference() {
    return (IGESData_GlobalNodeOfSpecificLib*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_GlobalNodeOfWriterLib(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_GlobalNodeOfWriterLib::Handle_IGESData_GlobalNodeOfWriterLib %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_GlobalNodeOfWriterLib : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_GlobalNodeOfWriterLib DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_GlobalNodeOfWriterLib {
    IGESData_GlobalNodeOfWriterLib* _get_reference() {
    return (IGESData_GlobalNodeOfWriterLib*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_IGESEntity(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_IGESEntity::Handle_IGESData_IGESEntity %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_IGESEntity : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_IGESEntity DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_IGESEntity {
    IGESData_IGESEntity* _get_reference() {
    return (IGESData_IGESEntity*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_IGESModel(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_IGESModel::Handle_IGESData_IGESModel %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_IGESModel : public Handle_Interface_InterfaceModel {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_IGESModel DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_IGESModel {
    IGESData_IGESModel* _get_reference() {
    return (IGESData_IGESModel*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_IGESReaderData(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_IGESReaderData::Handle_IGESData_IGESReaderData %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_IGESReaderData : public Handle_Interface_FileReaderData {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_IGESReaderData DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_IGESReaderData {
    IGESData_IGESReaderData* _get_reference() {
    return (IGESData_IGESReaderData*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_NodeOfSpecificLib(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_NodeOfSpecificLib::Handle_IGESData_NodeOfSpecificLib %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_NodeOfSpecificLib : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_NodeOfSpecificLib DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_NodeOfSpecificLib {
    IGESData_NodeOfSpecificLib* _get_reference() {
    return (IGESData_NodeOfSpecificLib*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_NodeOfWriterLib(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_NodeOfWriterLib::Handle_IGESData_NodeOfWriterLib %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_NodeOfWriterLib : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_NodeOfWriterLib DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_NodeOfWriterLib {
    IGESData_NodeOfWriterLib* _get_reference() {
    return (IGESData_NodeOfWriterLib*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_Protocol(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_Protocol::Handle_IGESData_Protocol %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_Protocol : public Handle_Interface_Protocol {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_Protocol DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_Protocol {
    IGESData_Protocol* _get_reference() {
    return (IGESData_Protocol*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_ReadWriteModule(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_ReadWriteModule::Handle_IGESData_ReadWriteModule %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_ReadWriteModule : public Handle_Interface_ReaderModule {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_ReadWriteModule DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_ReadWriteModule {
    IGESData_ReadWriteModule* _get_reference() {
    return (IGESData_ReadWriteModule*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_SpecificModule(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_SpecificModule::Handle_IGESData_SpecificModule %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_SpecificModule : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_SpecificModule DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_SpecificModule {
    IGESData_SpecificModule* _get_reference() {
    return (IGESData_SpecificModule*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_ToolLocation(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_ToolLocation::Handle_IGESData_ToolLocation %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_ToolLocation : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_ToolLocation DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_ToolLocation {
    IGESData_ToolLocation* _get_reference() {
    return (IGESData_ToolLocation*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_ColorEntity(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_ColorEntity::Handle_IGESData_ColorEntity %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_ColorEntity : public Handle_IGESData_IGESEntity {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_ColorEntity DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_ColorEntity {
    IGESData_ColorEntity* _get_reference() {
    return (IGESData_ColorEntity*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_DefaultGeneral(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_DefaultGeneral::Handle_IGESData_DefaultGeneral %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_DefaultGeneral : public Handle_IGESData_GeneralModule {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_DefaultGeneral DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_DefaultGeneral {
    IGESData_DefaultGeneral* _get_reference() {
    return (IGESData_DefaultGeneral*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_DefaultSpecific(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_DefaultSpecific::Handle_IGESData_DefaultSpecific %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_DefaultSpecific : public Handle_IGESData_SpecificModule {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_DefaultSpecific DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_DefaultSpecific {
    IGESData_DefaultSpecific* _get_reference() {
    return (IGESData_DefaultSpecific*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_FileProtocol(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_FileProtocol::Handle_IGESData_FileProtocol %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_FileProtocol : public Handle_IGESData_Protocol {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_FileProtocol DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_FileProtocol {
    IGESData_FileProtocol* _get_reference() {
    return (IGESData_FileProtocol*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_LabelDisplayEntity(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_LabelDisplayEntity::Handle_IGESData_LabelDisplayEntity %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_LabelDisplayEntity : public Handle_IGESData_IGESEntity {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_LabelDisplayEntity DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_LabelDisplayEntity {
    IGESData_LabelDisplayEntity* _get_reference() {
    return (IGESData_LabelDisplayEntity*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_LevelListEntity(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_LevelListEntity::Handle_IGESData_LevelListEntity %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_LevelListEntity : public Handle_IGESData_IGESEntity {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_LevelListEntity DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_LevelListEntity {
    IGESData_LevelListEntity* _get_reference() {
    return (IGESData_LevelListEntity*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_LineFontEntity(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_LineFontEntity::Handle_IGESData_LineFontEntity %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_LineFontEntity : public Handle_IGESData_IGESEntity {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_LineFontEntity DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_LineFontEntity {
    IGESData_LineFontEntity* _get_reference() {
    return (IGESData_LineFontEntity*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_NameEntity(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_NameEntity::Handle_IGESData_NameEntity %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_NameEntity : public Handle_IGESData_IGESEntity {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_NameEntity DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_NameEntity {
    IGESData_NameEntity* _get_reference() {
    return (IGESData_NameEntity*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_SingleParentEntity(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_SingleParentEntity::Handle_IGESData_SingleParentEntity %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_SingleParentEntity : public Handle_IGESData_IGESEntity {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_SingleParentEntity DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_SingleParentEntity {
    IGESData_SingleParentEntity* _get_reference() {
    return (IGESData_SingleParentEntity*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_TransfEntity(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_TransfEntity::Handle_IGESData_TransfEntity %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_TransfEntity : public Handle_IGESData_IGESEntity {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_TransfEntity DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_TransfEntity {
    IGESData_TransfEntity* _get_reference() {
    return (IGESData_TransfEntity*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_UndefinedEntity(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_UndefinedEntity::Handle_IGESData_UndefinedEntity %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_UndefinedEntity : public Handle_IGESData_IGESEntity {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_UndefinedEntity DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_UndefinedEntity {
    IGESData_UndefinedEntity* _get_reference() {
    return (IGESData_UndefinedEntity*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_ViewKindEntity(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_ViewKindEntity::Handle_IGESData_ViewKindEntity %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_ViewKindEntity : public Handle_IGESData_IGESEntity {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_ViewKindEntity DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_ViewKindEntity {
    IGESData_ViewKindEntity* _get_reference() {
    return (IGESData_ViewKindEntity*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_IGESData_FreeFormatEntity(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_IGESData_FreeFormatEntity::Handle_IGESData_FreeFormatEntity %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_IGESData_FreeFormatEntity : public Handle_IGESData_UndefinedEntity {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_IGESData_FreeFormatEntity DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_IGESData_FreeFormatEntity {
    IGESData_FreeFormatEntity* _get_reference() {
    return (IGESData_FreeFormatEntity*)$self->get();
    }
};
