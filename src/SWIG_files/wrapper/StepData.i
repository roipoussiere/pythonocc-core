	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_Described(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_Described::Handle_StepData_Described %{
...
class Handle_StepData_Described : public Handle_Standard_Transient {
    ...
    public:
        ...
        static const Handle_StepData_Described DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_Described {
    StepData_Described* _get_reference() {
    return (StepData_Described*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_EDescr(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_EDescr::Handle_StepData_EDescr %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_EDescr : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_EDescr DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_EDescr {
    StepData_EDescr* _get_reference() {
    return (StepData_EDescr*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_FileRecognizer(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_FileRecognizer::Handle_StepData_FileRecognizer %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_FileRecognizer : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_FileRecognizer DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_FileRecognizer {
    StepData_FileRecognizer* _get_reference() {
    return (StepData_FileRecognizer*)$self->get();
    }
};
...
class StepData_FreeFormEntity : public Standard_Transient {
	public:
		%feature("compactdefaultargs") StepData_FreeFormEntity;
		%feature("autodoc", "	* Creates a FreeFormEntity, with no field, no type

	:rtype: None
") StepData_FreeFormEntity;
		 StepData_FreeFormEntity ();
		%feature("compactdefaultargs") SetStepType;
		%feature("autodoc", "	* Sets the type of an entity For a complex one, the type of this member
...
") SetStepType;
		...
		%feature("autodoc", "	* Returns the recorded StepType For a complex one, the type of this member

	:rtype: char *
") StepType;
		const char * StepType ();
		%feature("compactdefaultargs") SetNext;
		%feature("autodoc", "	* Sets a next member, in order to define or complete a Complex entity If <last> is True --D--, this next will be set as last of list Else, it is inserted just as next of <self> If <next> is Null, Next is cleared

	:param next:
	:type next: Handle_StepData_FreeFormEntity &
	:param last: default value is Standard_True
	:type last: bool
	:rtype: None
") SetNext;
		void SetNext (const Handle_StepData_FreeFormEntity & next,const Standard_Boolean last = Standard_True);
		%feature("compactdefaultargs") Next;
		%feature("autodoc", "	* Returns the next member of a Complex entity --remark : the last member has none--

	:rtype: Handle_StepData_FreeFormEntity
") Next;
		Handle_StepData_FreeFormEntity Next ();
		%feature("compactdefaultargs") IsComplex;
		%feature("autodoc", "	* Returns True if a FreeFormEntity is Complex --i.e. has Next--

	:rtype: bool
") IsComplex;
		Standard_Boolean IsComplex ();
		%feature("compactdefaultargs") Typed;
		%feature("autodoc", "	* Returns the member of a FreeFormEntity of which the type name is given --exact match, no sub-type--

	:param typenam:
	:type typenam: char *
	:rtype: Handle_StepData_FreeFormEntity
") Typed;
		Handle_StepData_FreeFormEntity Typed (const char * typenam);
		%feature("compactdefaultargs") TypeList;
		%feature("autodoc", "	* Returns the list of types --one type for a simple entity--, as is --non reordered--

	:rtype: Handle_TColStd_HSequenceOfAsciiString
") TypeList;
		Handle_TColStd_HSequenceOfAsciiString TypeList ();
		%feature("compactdefaultargs") Reorder;
		%feature("autodoc", "	* Reorders a Complex entity if required, i.e. if member types are not in alphabetic order Returns False if nothing done --order was OK or simple entity--, True plus modified <ent> if <ent> has been reordered

	:param ent:
	:type ent: Handle_StepData_FreeFormEntity &
	:rtype: bool
") Reorder;
		static Standard_Boolean Reorder (Handle_StepData_FreeFormEntity & ent);
		%feature("compactdefaultargs") SetNbFields;
		%feature("autodoc", "	* Sets a count of Fields, from scratch
...
") NbFields;
	...
	:rtype: StepData_Field
") Field;
		const StepData_Field & Field (const Standard_Integer num);
		%feature("compactdefaultargs") CField;
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_FreeFormEntity(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_FreeFormEntity::Handle_StepData_FreeFormEntity %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_FreeFormEntity : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_FreeFormEntity DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_FreeFormEntity {
    StepData_FreeFormEntity* _get_reference() {
    return (StepData_FreeFormEntity*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_GeneralModule(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_GeneralModule::Handle_StepData_GeneralModule %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_GeneralModule : public Handle_Interface_GeneralModule {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_GeneralModule DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_GeneralModule {
    StepData_GeneralModule* _get_reference() {
    return (StepData_GeneralModule*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_GlobalNodeOfWriterLib(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_GlobalNodeOfWriterLib::Handle_StepData_GlobalNodeOfWriterLib %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_GlobalNodeOfWriterLib : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_GlobalNodeOfWriterLib DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_GlobalNodeOfWriterLib {
    StepData_GlobalNodeOfWriterLib* _get_reference() {
    return (StepData_GlobalNodeOfWriterLib*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_NodeOfWriterLib(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_NodeOfWriterLib::Handle_StepData_NodeOfWriterLib %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_NodeOfWriterLib : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_NodeOfWriterLib DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_NodeOfWriterLib {
    StepData_NodeOfWriterLib* _get_reference() {
    return (StepData_NodeOfWriterLib*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_PDescr(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_PDescr::Handle_StepData_PDescr %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_PDescr : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_PDescr DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_PDescr {
    StepData_PDescr* _get_reference() {
    return (StepData_PDescr*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_Protocol(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_Protocol::Handle_StepData_Protocol %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_Protocol : public Handle_Interface_Protocol {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_Protocol DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_Protocol {
    StepData_Protocol* _get_reference() {
    return (StepData_Protocol*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_ReadWriteModule(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_ReadWriteModule::Handle_StepData_ReadWriteModule %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_ReadWriteModule : public Handle_Interface_ReaderModule {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_ReadWriteModule DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_ReadWriteModule {
    StepData_ReadWriteModule* _get_reference() {
    return (StepData_ReadWriteModule*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_SelectMember(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_SelectMember::Handle_StepData_SelectMember %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_SelectMember : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_SelectMember DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_SelectMember {
    StepData_SelectMember* _get_reference() {
    return (StepData_SelectMember*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_StepModel(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_StepModel::Handle_StepData_StepModel %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_StepModel : public Handle_Interface_InterfaceModel {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_StepModel DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_StepModel {
    StepData_StepModel* _get_reference() {
    return (StepData_StepModel*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_StepReaderData(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_StepReaderData::Handle_StepData_StepReaderData %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_StepReaderData : public Handle_Interface_FileReaderData {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_StepReaderData DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_StepReaderData {
    StepData_StepReaderData* _get_reference() {
    return (StepData_StepReaderData*)$self->get();
    }
};
...
class StepData_UndefinedEntity : public Standard_Transient {
	public:
		%feature("compactdefaultargs") StepData_UndefinedEntity;
...
") StepData_UndefinedEntity;
		 StepData_UndefinedEntity ();
		%feature("compactdefaultargs") StepData_UndefinedEntity;
		%feature("autodoc", "	* Creates a SubList of an Unknown entity : it is an Unknown Entity with no Type, but flagged as 'SUB' if issub is True
...
") StepData_UndefinedEntity;
		...
		%feature("autodoc", "	* Returns the UndefinedContent which brings the Parameters
...
") UndefinedContent;
		...
		%feature("autodoc", "	* Returns True if an Unndefined Entity is SubPart of another one

	:rtype: bool
") IsSub;
		Standard_Boolean IsSub ();
		%feature("compactdefaultargs") Super;
		%feature("autodoc", "	* Returns the 'super-entity' of a sub-part

	:rtype: Handle_StepData_UndefinedEntity
") Super;
		Handle_StepData_UndefinedEntity Super ();
		%feature("compactdefaultargs") IsComplex;
		%feature("autodoc", "	* Returns True if <self> defines a Multiple Type Entity --see ANDOR--

	:rtype: bool
") IsComplex;
		Standard_Boolean IsComplex ();
		%feature("compactdefaultargs") Next;
		%feature("autodoc", "	* For a Multiple Type Entity, returns the Next 'Componant' For more than two Types, iterative definition --Next->Next...-- Returns a Null Handle for the end of the List

	:rtype: Handle_StepData_UndefinedEntity
") Next;
		Handle_StepData_UndefinedEntity Next ();
		%feature("compactdefaultargs") StepType;
		%feature("autodoc", "	* gives entity type, read from file For a Complex Type Entity, gives the first Type read, each 'Next' gives its 'partial' type was C++ : return const

	:rtype: char *
") StepType;
		const char * StepType ();
		%feature("compactdefaultargs") ReadRecord;
		%feature("autodoc", "	* reads data from StepReaderData --i.e. from file--, by filling StepType and parameters stored in the UndefinedContent

	:param SR:
	:type SR: Handle_StepData_StepReaderData &
	:param num:
	:type num: int
	:param ach:
	:type ach: Handle_Interface_Check &
...
") ReadRecord;
		...
		%feature("compactdefaultargs") WriteParams;
		%feature("autodoc", "	* write data to StepWriter, taken from UndefinedContent

	:param SW:
	:type SW: StepData_StepWriter &
	:rtype: None
") WriteParams;
		void WriteParams (StepData_StepWriter & SW);
		%feature("compactdefaultargs") GetFromAnother;
		%feature("autodoc", "	* reads another UndefinedEntity from StepData

	:param other:
	:type other: Handle_StepData_UndefinedEntity &
	:param TC:
	:type TC: Interface_CopyTool &
	:rtype: None
") GetFromAnother;
		...
		%feature("compactdefaultargs") FillShared;
		%feature("autodoc", "	* Fills the list of shared entities

	:param list:
	:type list: Interface_EntityIterator &
	:rtype: None
") FillShared;
		void FillShared (Interface_EntityIterator & list);
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_UndefinedEntity(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_UndefinedEntity::Handle_StepData_UndefinedEntity %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_UndefinedEntity : public Handle_Standard_Transient {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_UndefinedEntity DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_UndefinedEntity {
    StepData_UndefinedEntity* _get_reference() {
    return (StepData_UndefinedEntity*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_DefaultGeneral(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_DefaultGeneral::Handle_StepData_DefaultGeneral %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_DefaultGeneral : public Handle_StepData_GeneralModule {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_DefaultGeneral DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_DefaultGeneral {
    StepData_DefaultGeneral* _get_reference() {
    return (StepData_DefaultGeneral*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_DescrGeneral(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_DescrGeneral::Handle_StepData_DescrGeneral %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_DescrGeneral : public Handle_StepData_GeneralModule {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_DescrGeneral DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_DescrGeneral {
    StepData_DescrGeneral* _get_reference() {
    return (StepData_DescrGeneral*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_DescrReadWrite(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_DescrReadWrite::Handle_StepData_DescrReadWrite %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_DescrReadWrite : public Handle_StepData_ReadWriteModule {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_DescrReadWrite DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_DescrReadWrite {
    StepData_DescrReadWrite* _get_reference() {
    return (StepData_DescrReadWrite*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_ECDescr(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_ECDescr::Handle_StepData_ECDescr %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_ECDescr : public Handle_StepData_EDescr {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_ECDescr DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_ECDescr {
    StepData_ECDescr* _get_reference() {
    return (StepData_ECDescr*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_ESDescr(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_ESDescr::Handle_StepData_ESDescr %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_ESDescr : public Handle_StepData_EDescr {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_ESDescr DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_ESDescr {
    StepData_ESDescr* _get_reference() {
    return (StepData_ESDescr*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_FileProtocol(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_FileProtocol::Handle_StepData_FileProtocol %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_FileProtocol : public Handle_StepData_Protocol {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_FileProtocol DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_FileProtocol {
    StepData_FileProtocol* _get_reference() {
    return (StepData_FileProtocol*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_Plex(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_Plex::Handle_StepData_Plex %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_Plex : public Handle_StepData_Described {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_Plex DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_Plex {
    StepData_Plex* _get_reference() {
    return (StepData_Plex*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_SelectInt(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_SelectInt::Handle_StepData_SelectInt %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_SelectInt : public Handle_StepData_SelectMember {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_SelectInt DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_SelectInt {
    StepData_SelectInt* _get_reference() {
    return (StepData_SelectInt*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_SelectNamed(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_SelectNamed::Handle_StepData_SelectNamed %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_SelectNamed : public Handle_StepData_SelectMember {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_SelectNamed DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_SelectNamed {
    StepData_SelectNamed* _get_reference() {
    return (StepData_SelectNamed*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_SelectReal(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_SelectReal::Handle_StepData_SelectReal %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_SelectReal : public Handle_StepData_SelectMember {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_SelectReal DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_SelectReal {
    StepData_SelectReal* _get_reference() {
    return (StepData_SelectReal*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_Simple(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_Simple::Handle_StepData_Simple %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_Simple : public Handle_StepData_Described {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_Simple DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_Simple {
    StepData_Simple* _get_reference() {
    return (StepData_Simple*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_DescrProtocol(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_DescrProtocol::Handle_StepData_DescrProtocol %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_DescrProtocol : public Handle_StepData_FileProtocol {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_DescrProtocol DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_DescrProtocol {
    StepData_DescrProtocol* _get_reference() {
    return (StepData_DescrProtocol*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_StepData_SelectArrReal(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_StepData_SelectArrReal::Handle_StepData_SelectArrReal %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}
...
class Handle_StepData_SelectArrReal : public Handle_StepData_SelectNamed {
    ...
    public:
        ...
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_StepData_SelectArrReal DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_StepData_SelectArrReal {
    StepData_SelectArrReal* _get_reference() {
    return (StepData_SelectArrReal*)$self->get();
    }
};
