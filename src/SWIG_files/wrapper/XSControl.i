...
%extend Handle_XSControl_ConnectedShapes {
    ...
    return (XSControl_ConnectedShapes*)$self->get();
    }
};
...
class Handle_XSControl_Controller : public Handle_Standard_Transient {
...
%extend Handle_XSControl_Controller {
    ...
    return (XSControl_Controller*)$self->get();
    }
};
...
%extend Handle_XSControl_SelectForTransfer {
    ...
    return (XSControl_SelectForTransfer*)$self->get();
    }
};
...
%extend Handle_XSControl_SignTransferStatus {
    ...
    return (XSControl_SignTransferStatus*)$self->get();
    }
};
...
class Handle_XSControl_TransferReader : public Handle_Standard_Transient {
...
%extend Handle_XSControl_TransferReader {
    ...
    return (XSControl_TransferReader*)$self->get();
    }
};
...
class Handle_XSControl_TransferWriter : public Handle_Standard_Transient {
...
%extend Handle_XSControl_TransferWriter {
    ...
    return (XSControl_TransferWriter*)$self->get();
    }
};
...
%extend Handle_XSControl_WorkSession {
    ...
    return (XSControl_WorkSession*)$self->get();
    }
};
