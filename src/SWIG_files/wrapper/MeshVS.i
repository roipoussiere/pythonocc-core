	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_MeshVS_CommonSensitiveEntity(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_MeshVS_CommonSensitiveEntity::Handle_MeshVS_CommonSensitiveEntity %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}

%nodefaultctor Handle_MeshVS_CommonSensitiveEntity;
class Handle_MeshVS_CommonSensitiveEntity : public Handle_Select3D_SensitiveSet {

    public:
        // constructors
        Handle_MeshVS_CommonSensitiveEntity();
        Handle_MeshVS_CommonSensitiveEntity(const Handle_MeshVS_CommonSensitiveEntity &aHandle);
        Handle_MeshVS_CommonSensitiveEntity(const MeshVS_CommonSensitiveEntity *anItem);
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_MeshVS_CommonSensitiveEntity DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_MeshVS_CommonSensitiveEntity {
    MeshVS_CommonSensitiveEntity* _get_reference() {
    return (MeshVS_CommonSensitiveEntity*)$self->get();
    }
};
...
class Handle_MeshVS_DataSource : public Handle_Standard_Transient {
...
%extend Handle_MeshVS_DataSource {
    ...
    return (MeshVS_DataSource*)$self->get();
    }
};
...
class Handle_MeshVS_Drawer : public Handle_Standard_Transient {
...
%extend Handle_MeshVS_DummySensitiveEntity {
    ...
    return (MeshVS_DummySensitiveEntity*)$self->get();
    }
};
...
%extend Handle_MeshVS_MeshEntityOwner {
    ...
    return (MeshVS_MeshEntityOwner*)$self->get();
    }
};
...
%extend Handle_MeshVS_MeshOwner {
    ...
    return (MeshVS_MeshOwner*)$self->get();
    }
};
...
class Handle_MeshVS_PrsBuilder : public Handle_Standard_Transient {
...
%extend Handle_MeshVS_PrsBuilder {
    ...
    return (MeshVS_PrsBuilder*)$self->get();
    }
};
...
%extend Handle_MeshVS_SensitiveFace {
    ...
    return (MeshVS_SensitiveFace*)$self->get();
    }
};
...
%extend Handle_MeshVS_SensitiveMesh {
    ...
    return (MeshVS_SensitiveMesh*)$self->get();
    }
};
...
%extend Handle_MeshVS_SensitivePolyhedron {
    ...
    return (MeshVS_SensitivePolyhedron*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_MeshVS_SensitiveQuad(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_MeshVS_SensitiveQuad::Handle_MeshVS_SensitiveQuad %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}

%nodefaultctor Handle_MeshVS_SensitiveQuad;
class Handle_MeshVS_SensitiveQuad : public Handle_Select3D_SensitiveEntity {

    public:
        // constructors
        Handle_MeshVS_SensitiveQuad();
        Handle_MeshVS_SensitiveQuad(const Handle_MeshVS_SensitiveQuad &aHandle);
        Handle_MeshVS_SensitiveQuad(const MeshVS_SensitiveQuad *anItem);
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_MeshVS_SensitiveQuad DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_MeshVS_SensitiveQuad {
    MeshVS_SensitiveQuad* _get_reference() {
    return (MeshVS_SensitiveQuad*)$self->get();
    }
};
...
%extend Handle_MeshVS_SensitiveSegment {
    ...
    return (MeshVS_SensitiveSegment*)$self->get();
    }
};
...
%extend Handle_MeshVS_DataSource3D {
    ...
    return (MeshVS_DataSource3D*)$self->get();
    }
};
...
%extend Handle_MeshVS_DeformedDataSource {
    ...
    return (MeshVS_DeformedDataSource*)$self->get();
    }
};
...
%extend Handle_MeshVS_ElementalColorPrsBuilder {
    ...
    return (MeshVS_ElementalColorPrsBuilder*)$self->get();
    }
};
...
%extend Handle_MeshVS_MeshPrsBuilder {
    ...
    return (MeshVS_MeshPrsBuilder*)$self->get();
    }
};
...
%extend Handle_MeshVS_NodalColorPrsBuilder {
    ...
    return (MeshVS_NodalColorPrsBuilder*)$self->get();
    }
};
...
%extend Handle_MeshVS_TextPrsBuilder {
    ...
    return (MeshVS_TextPrsBuilder*)$self->get();
    }
};
...
%extend Handle_MeshVS_VectorPrsBuilder {
    ...
    return (MeshVS_VectorPrsBuilder*)$self->get();
    }
};
