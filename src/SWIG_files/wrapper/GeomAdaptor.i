...
%extend Handle_GeomAdaptor_GHCurve {
    ...
    return (GeomAdaptor_GHCurve*)$self->get();
    }
};
...
%extend Handle_GeomAdaptor_GHSurface {
    ...
    return (GeomAdaptor_GHSurface*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_GeomAdaptor_HSurfaceOfLinearExtrusion(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_GeomAdaptor_HSurfaceOfLinearExtrusion::Handle_GeomAdaptor_HSurfaceOfLinearExtrusion %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}

%nodefaultctor Handle_GeomAdaptor_HSurfaceOfLinearExtrusion;
class Handle_GeomAdaptor_HSurfaceOfLinearExtrusion : public Handle_Adaptor3d_HSurface {

    public:
        // constructors
        Handle_GeomAdaptor_HSurfaceOfLinearExtrusion();
        Handle_GeomAdaptor_HSurfaceOfLinearExtrusion(const Handle_GeomAdaptor_HSurfaceOfLinearExtrusion &aHandle);
        Handle_GeomAdaptor_HSurfaceOfLinearExtrusion(const GeomAdaptor_HSurfaceOfLinearExtrusion *anItem);
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_GeomAdaptor_HSurfaceOfLinearExtrusion DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_GeomAdaptor_HSurfaceOfLinearExtrusion {
    GeomAdaptor_HSurfaceOfLinearExtrusion* _get_reference() {
    return (GeomAdaptor_HSurfaceOfLinearExtrusion*)$self->get();
    }
};
	...
	%pythoncode {
		def GetHandle(self):
		    try:
		        ...
		        self.thisHandle = Handle_GeomAdaptor_HSurfaceOfRevolution(self)
		        self.thisown = False
		        return self.thisHandle
	}
};

%pythonappend Handle_GeomAdaptor_HSurfaceOfRevolution::Handle_GeomAdaptor_HSurfaceOfRevolution %{
    # register the handle in the base object
    if len(args) > 0:
        register_handle(self, args[0])
%}

%nodefaultctor Handle_GeomAdaptor_HSurfaceOfRevolution;
class Handle_GeomAdaptor_HSurfaceOfRevolution : public Handle_Adaptor3d_HSurface {

    public:
        // constructors
        Handle_GeomAdaptor_HSurfaceOfRevolution();
        Handle_GeomAdaptor_HSurfaceOfRevolution(const Handle_GeomAdaptor_HSurfaceOfRevolution &aHandle);
        Handle_GeomAdaptor_HSurfaceOfRevolution(const GeomAdaptor_HSurfaceOfRevolution *anItem);
        void Nullify();
        Standard_Boolean IsNull() const;
        static const Handle_GeomAdaptor_HSurfaceOfRevolution DownCast(const Handle_Standard_Transient &AnObject);

};

%extend Handle_GeomAdaptor_HSurfaceOfRevolution {
    GeomAdaptor_HSurfaceOfRevolution* _get_reference() {
    return (GeomAdaptor_HSurfaceOfRevolution*)$self->get();
    }
};
...
%extend Handle_GeomAdaptor_HCurve {
    ...
    return (GeomAdaptor_HCurve*)$self->get();
    }
};
...
%extend Handle_GeomAdaptor_HSurface {
    ...
    return (GeomAdaptor_HSurface*)$self->get();
    }
};
