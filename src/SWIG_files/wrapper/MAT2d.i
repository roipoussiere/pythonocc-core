...
class Handle_MAT2d_Circuit : public Handle_Standard_Transient {
...
class Handle_MAT2d_Connexion : public Handle_Standard_Transient {
...
%extend Handle_MAT2d_Connexion {
    ...
    return (MAT2d_Connexion*)$self->get();
    }
};
